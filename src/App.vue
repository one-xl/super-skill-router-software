...
import { Database, LayoutList, Network, Wand2 } from "@lucide/vue";
import { ref } from "vue";
import Discover from "./views/Discover.vue";
import Compose from "./views/Compose.vue";
import Manage from "./views/Manage.vue";

const view = ref<"discover" | "compose" | "manage">("discover");
</script>
